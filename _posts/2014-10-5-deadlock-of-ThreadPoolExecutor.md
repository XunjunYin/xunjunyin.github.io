...
* 在做实验之前答案并不确定，要看ThreadPoolExecutor是否能实现的这么好了。所以先看了下[[http://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ThreadPoolExecutor.html | ThreadPoolExecutor的java doc]]，并注意其中关于类似死锁相关逻辑的说明，果然，可以看到关于direct handoff的说明：
